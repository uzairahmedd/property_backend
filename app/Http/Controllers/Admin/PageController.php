...
class PageController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $pages=Terms::where('type','page')->latest()->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        $check=Terms::where('type','page')->where('slug',$creat_slug)->count();
        if ($check != 0) {
    ...
    public function update(Request $request, $id)
    {
        ...
        $checktitle= Terms::where('type','page')->where('title',$request->name)->where('id','!=',$id)->first();
        $checkslug= Terms::where('type','page')->where('slug',$request->slug)->where('id','!=',$id)->first();
        if (!empty($checkslug)) {
