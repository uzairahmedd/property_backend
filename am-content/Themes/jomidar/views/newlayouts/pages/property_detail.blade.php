        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="theme-bg-secondary text-center mb-0 pb-0 position-relative mt-3">
                    <h3 class="font-medium font-20 theme-text-white pb-2 pt-1">{{__('labels.address_property')}}</h3>
...
<script src="{{theme_asset('assets/newjs/property_detail.min.js')}}"></script>
@endpush