            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active show" id="home-tab3" data-toggle="tab" href="#step1" role="tab"
                    ...
                    <div class="tab-content" id="myTabContent2">
                        ...
                        <div class="tab-pane fade active show" id="step1" role="tabpanel" aria-labelledby="home-tab3">
                            <div class="pt-20">
                                <form id="productform" novalidate method="post"
                                      action="{{ route('admin.property.update',$info->id) }}">
                                    @csrf
                                    <div class="form-group">
                                        <label for="title">{{ __('labels.property_type') }}</label>
                                        <select class="form-control form-select-lg mb-3"
                                                aria-label=".form-select-lg example">
                                            <option value='' disabled selected>{{ __('labels.property_type') }}</option>
                                            ...
                                            <select class="form-control selectric" id="state" name="state[]">
                                                ...
                                                @foreach($cities as $city)
                                                    <option value="{{ $city->id }}"
                                                            @if(in_array($row->id, $array)) selected="" @endif>{{ $row->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group none city col-6">
                                            <label for="title">{{ __('labels.district') }}</label>
                                            <select class="form-control" name="city" id="city">
                                                <option disabled="" selected="">{{ __('labels.district') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    @php
