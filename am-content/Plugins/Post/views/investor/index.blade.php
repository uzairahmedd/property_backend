...
@section('content')
@include('layouts.backend.partials.headersection',['title'=>'Investors'])
<div class="card"  >
	<div class="card-body">
		<div class="row mb-30">
			<div class="col-lg-6">
			...
			<div class="col-lg-6">
				<div class="add-new-btn">
					<a href="{{ route('admin.investor.create') }}" class="btn float-right btn-primary">{{ __('Add New') }}</a>
				</div>
			</div>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								{{ $post->name }}
								<div class="hover">
									<a href="{{ route('admin.investor.edit',$post->id) }}">{{ __('Edit') }}</a>
								</div>
							</td>
							<td>{{ __('Last Modified') }}
								<div class="date">
