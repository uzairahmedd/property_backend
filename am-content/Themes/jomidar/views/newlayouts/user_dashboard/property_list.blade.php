        ...
        <div class="nav-tab">
            ...
            <div class="all-listing">
                <div class="property-lists">
                    <div class="row" id="user_property_list">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 ">
                    <div class="show-pagination-info text-center">
                        <p class="show-info">{{ __('Showing') }} <span><span id="user_from"></span> - <span id="user_to"></span> {{ __('of') }} <span id="user_total"></span></span> {{ __('List') }}</p>
                    </div>
                </div>
            </div>
        </div>
