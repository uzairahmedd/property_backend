	...
	<div class="col-lg-9">
		<div class="card">
			<div class="card-body">
				...
				<form method="post" action="{{ route('admin.agency.store') }}" id="basicform">
					@csrf
					<div class="pt-20">
						@php
						$arr['title']= 'Name';
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" cols="30" class="form-control" rows="8" placeholder="Address"></textarea>
                        </div>
                        <div class="form-group">
