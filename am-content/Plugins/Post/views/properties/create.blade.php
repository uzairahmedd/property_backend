                    ...
                    <ul class="nav nav-pills d-flex justify-content-between" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_2" role="tab"
                               aria-controls="step_2" aria-selected="true">Step 2</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#images" role="tab"
                               aria-controls="profile" aria-selected="false">Step 4</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_5" role="tab" aria-controls="step_5"
                               aria-selected="true">Step 5</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_6" role="tab" aria-controls="step_6"
                               aria-selected="true">Step 6</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab3" data-toggle="tab" href="#finish" role="tab" aria-controls="finish"
                               aria-selected="true">Finish</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade active show" id="step_1" role="tabpanel" aria-labelledby="step_1">
                            <form method="post" action="{{ route('admin.property.store') }}">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <select class="form-control form-select-lg mb-3" required="" name="status"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="exampleFormControlTextarea2"
                                                   placeholder="Enter English title" required="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ar_title" id="exampleFormControlTextarea1"
                                                   placeholder="Enter Arabic title" required="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="location" placeholder="Address" name="location"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="city" required="" id="region"
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" name="parent_category"
                                                    required="" id="nature" aria-label=".form-select-lg example">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" required=""
                                                    id="property_type" name="category"
                                                    aria-label=".form-select-lg example">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" id="price" required=""
                                                   placeholder="Propery price" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" id="electricity"
                                                    name="electricity_facility" aria-label=".form-select-lg example">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" id="water"
                                                    name="water_facility" aria-label=".form-select-lg example">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required="" max='4' min='0' id="streets" name="streets"
                                                   placeholder="No of streets" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="street_info_one">Street Information 1</label>
                                            <input type="text" name="street_info_one" id="street_info_one"
                                                   placeholder="Street Information 1" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="street_info_two">Street Information 2</label>
                                            <input type="text" name="street_info_two" id="street_info_two"
                                                   placeholder="Street Information 2" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <!-- end step two -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="Parking" name="Parking" required="" max='6'
                                                       min="0" placeholder="NO of Parking" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" max='6' min="0" name="Board" required="" id="Board"
                                                       placeholder="No of Board" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="" name="lounges" max='6' required="" min="0"
                                                       placeholder="No of Lounges" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="Bathrooms" name="Bathrooms" max="6" min="0"
                                                       placeholder="No of Bathrooms" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="Bedrooms">No of Bedrooms</label>
                                                <input type="number" id="Bedrooms" name="Bedrooms" required="" max='6'
                                                       min="0" placeholder="No of Bedrooms" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="role" id="role" placeholder="Property role"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="virtual_tour" id="virtual_tour"
                                                   placeholder="Video link" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="features" class="form-select form-control" aria-label="Default select example" name="features[]">
                                                <option selected>Please setelect features</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="id_number" name="id_number"
                                                   placeholder="Identification No" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="instrument_number">Instrument No.</label>
                                            <input type="text" name="instrument_number" id="instrument_number"
                                                   placeholder="Instrument No" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <!-- end third step -->
