                            ...
                            <div class="col-lg-6 mb-30">
                                <div class="single-pricing text-center">
                                    ...
                                    <div class="pricing-price">
                                        <h2>{{ format_currency($row->count) }}</h2>
                                    </div>
                                    <div class="per-month">
                                        <span>{{ __('Credit') }}: </span><span>{{ number_format($row->featured) }}</span>
                                    </div>
                                    
                                    <div class="pricing-btn">
                                        <a href="{{ route('agent.package.purchase_page',$row->id) }}">{{ __('Purchase Now') }}</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
