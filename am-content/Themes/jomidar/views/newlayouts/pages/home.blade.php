...
@section('content')
    ...
    <div class="header d-flex flex-column align-items-center">
        <li class="col-12 col-sm-10 col-lg-8 col-xl-5">
            <h1 class="font-medium theme-text-white text-center">{{__('labels.exclusive_platform')}} <span
                    class="font-bold">{{__('labels.kingdom')}}</span></h1>
        </li>
            ...
            <div class="col-12 row looking-for theme-bg-white d-flex flex-lg-row flex-sm-row align-items-center">
                <div class="col-lg-2 search-button-div col-md-2 col-sm-2 col-xs-12" id="search">
                    <button type="submit" id="hero_search_btn" title="Search property" data-toggle="tooltip">
                        <img type="submit" id="hero_search_btn" class="search-home-img"
                             src="{{theme_asset('assets/images/search.svg')}}" alt=""><span
                            class="search-txt">Search</span></button>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dropdown complete-rent-drop">
                        <span class="rental-toggle-icon"><img src="{{theme_asset('assets/images/arrow-down.svg')}}"
                                                              alt=""></span>
                        ...
                        <button class="btn dropdown-toggle rent-dropdown-toggle rent-btn" role="button"
                                id="dropdownMenuLink-home" data-bs-toggle="dropdown" aria-expanded="false"
                                data-toggle="dropdown">{{__('labels.rent')}}
                        </button>
                                ...
                                <div class="row">
                                    <div class="col-12 p-0">
                                        ...
                                        <nav>
                                            ...
                                            <div
                                                class="nav nav-tabs mb-4 rent-tabs d-flex justify-content-center align-items-center"
                                                id="nav-tab" role="tablist">
                                                @foreach($status as $status_data)
                                                    @if( $status_data->name =='Sale')
                                                        <a class="nav-item nav-link rent-link nav-sale active"
                                                           id="nav-rent-tab" data-bs-toggle="tab"
                                                           data-value="{{$status_data->id}}" href="#nav-rent" role="tab"
                                                           aria-controls="nav-rent"
                                                           aria-selected="true">{{__('labels.sale')}}</a>
                                                    @elseif( $status_data->name =='Rent')
                                                        <a class="nav-item nav-link rent-link nav-rent" id="nav-buy-tab"
                                                           data-bs-toggle="tab" href="#nav-buy"
                                                           data-value="{{$status_data->id}}" role="tab"
                                                           aria-controls="nav-buy"
                                                           aria-selected="false">{{__('labels.rent')}}</a>
                                                    @endif
                                                @endforeach
                                            </div>
                                        </nav>
                                                ...
                                                <!-- <div
                                                    ...
                                                    <li class="rent-all">
                                                        <input class="rent-select-dropdown" value="" type="radio"
                                                               id="radio02-01" checked/>
                                                        <label class="rent-box any" for="radio02-01">الجميع</label>
                                                    </li>

                                                    <li class="rent-all">
                                                        <input class="rent-select-dropdown drive_percent-box" value=""
                                                               type="radio" id="radio02-02"/>
                                                        <label class="rent-box rent_label_list"
                                                               for="radio02-02">يومياً</label>
                                                    </li>

                                                    <li class="rent-all">
                                                        <input class="rent-select-dropdown drive_percent-box" value=""
                                                               type="radio" id="radio03-03"/>
                                                        <label class="rent-box project_label"
                                                               for="radio03-03">أسبوعياً</label>
                                                    </li>

                                                    <li class="rent-all">
                                                        <input class="rent-select-dropdown drive_percent-box" value=""
                                                               type="radio" id="radio04-04"/>
                                                        <label class="rent-box project_label"
                                                               for="radio04-04">شهرياً</label>
                                                    </li>

                                                    <li class="rent-all">
                                                        <input class="rent-select-dropdown drive_percent-box" value=""
                                                               type="radio" id="radio05-05"/>
                                                        <label class="rent-box project_label"
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <div class="dropdown complete-resident-drop">
                        <span class="rent-toggle-icon rental-toggle-icon" id="rent-t-icon"><img
                                src="{{theme_asset('assets/images/arrow-down.svg')}}" alt=""></span>
                        <button class="btn dropdown-toggle resident-dropdown-toggle resident-btn" role="button"
                                id="dropdownMenuLink1" name="category" value="" onclick="" data-bs-toggle="dropdown"
                                aria-expanded="false" data-toggle="dropdown">{{__('labels.residential')}}
                        </button>
                            ...
                            <div class="resident-dropdown-content">
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <!-- Tab -->
                                        <nav>
                                            <div class="nav nav-tabs mb-4 resident-tabs" id="nav-tab-main"
                                                 role="tablist">
                                                @foreach($property_nature as $nature)
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="nav-residential" role="tabpanel"
        ...
        <div class="container position-relative">
            @if(isset($status_properties['sell_property']) && count($status_properties['sell_property']) > 0)
                <div class="property-listing-content d-flex align-items-center justify-content-between">
                    @foreach($status as $status_data)
                        @if( $status_data->name =='Sale')
                            <p class="mb-0 theme-text-sky font-medium"><a
                                    href="{{ route('list', ['status' => $status_data->id]) }}"><i
                                        class="fa-solid fa-arrow-left pe-1 ar-arrow"></i>{{__('labels.show_more')}}<i
                                        class="fa-solid fa-arrow-right ps-1 en-arrow"></i></a></p>
                        @endif
                    @endforeach
                        ...
                        @foreach($status_properties['sell_property'] as $sale_data)
                            ...
                            <div class="listing">
                                <div class="list" style="background-image: url({{$image}});">
                                    <div class="content d-flex justify-content-between">
                                        ...
                                        @if (Auth::check())
                                            ...
                                            <div class="fav-elipse d-flex align-items-center justify-content-center"
                                                 onclick="favourite_property('{{$sale_data->id}}')">
                                                <i class="fa-regular fa-heart {{isset($property_id) ? 'fa-solid' : 'fa-regular'}} heart{{$sale_data->id}}"
                                                   title="Favorite property" data-toggle="tooltip"></i>
                                            </div>
                                        @else
                                            <div class="fav-elipse d-flex align-items-center justify-content-center"
                                    ...
                                    <div
                                        class="price theme-text-white d-flex align-items-center justify-content-center">
                                        <span
                                ...
                                <div class="list" style="background-image: url({{$rent_image}});">
                                    ...
                                    <div class="content d-flex justify-content-between">
                                        ...
                                        @if (Auth::check())
                                            ...
                                            @endphp
                                            <div class="fav-elipse d-flex align-items-center justify-content-center"
                                                 onclick="favourite_property('{{$rent_data->id}}')">
                                                <i class="fa-regular fa-heart {{isset($property_id) ? 'fa-solid' : 'fa-regular'}} heart{{$rent_data->id}}"
                                                   title="Favorite property" data-toggle="tooltip"></i>
                                            </div>
                                        @else
                                            <div class="fav-elipse d-flex align-items-center justify-content-center"
                ...
                <div class="col-12 col-lg-5 text-end apps-content d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-end apps-store">
                        ...
                        <img src="{{theme_asset('assets/images/apple-store.png')}}"
                             class="mb-3 mb-sm-0 ms-sm-4 img-fluid" alt="apple-store">
                    </div>
                </div>
            </div>
        </div>
