                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-select-lg mb-3" id="property_type"
                                                        aria-label=".form-select-lg example">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-select-lg mb-3"
                                                    ...
                                                    @for($i=0; $i<=4; $i++)
                                                        <option
                                                            value="1" {{ !empty($info->streets) && $info->streets->content == $i ? "selected"  : "" }}>
                                                            {{$i}}
                                                        </option>
                                                    @endfor
                                                </select>
                                ...
                                <form id="productform" novalidate method="post"
                                    ...
                                    <div class="p-0 m-0 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select multiple="" id="features" class="form-control select2"
                                                    name="features[]">
                                                <option value="">Please setelect features</option>
                                                @foreach(App\Category::where('type','feature')->get() as $row)
                                                    <option value="{{ $row->id}}"
                                                            @if(in_array($row->id, $features_array)) selected="" @endif >{{ $row->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="{{ !empty( $info->instrument_number) ? $info->instrument_number->content  : '' }}"
                                                       placeholder="10251511212151">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       value="{{ !empty( $info->id_number) ? $info->id_number->content  : '' }}"
                                                       placeholder="a4234234243">
                                            </div>
                                        </div>
                                    </div>
                            </div>
