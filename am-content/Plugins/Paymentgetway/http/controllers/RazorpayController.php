...
class RazorpayController extends controller
{
    ...
    public static function make_payment($array)
    {
        ...
        RazorpayController::$key_id=$razorpay_credentials['key_id'];
        RazorpayController::$key_secret=$razorpay_credentials['key_secret'];
        RazorpayController::$currency=$razorpay_credentials['currency'];
        ...
        $referance_id=Str::random(10);
        $order = $api->order->create(array(
            'receipt' => $referance_id,
            'amount' => $amount*100,
            'currency' => RazorpayController::$currency
        )
        );
