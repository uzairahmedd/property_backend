                ...
                <div class="d-flex flex-column align-items-end">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 d-flex flex-column align-items-end">
                        ...
                        <div class="position-relative d-flex justify-content-end align-items-center w-100">
                            <input type="text" value="{{ $post_data != '' ? $post_data->title : old('title')}}" name="title" id="title" placeholder="عنوان الملكية" class="form-control theme-border">
                        </div>
                        @if($errors->has('title'))
                    ...
                    <div class="col-12 d-flex flex-wrap justify-content-end mb-4_5 mt-4">
                        ...
                        <div class="col-12 d-flex flex-wrap justify-content-end">
                            <textarea name="description" cols="30" rows="3" placeholder="ادخل هنا.." id="description" class="form-control b-r-8 theme-border">{{ $post_data != '' ? $post_data->description->content  : (old("description")) }}</textarea>
                        </div>
                    ...
                    <div class="col-12 d-flex flex-column-reverse flex-lg-row justify-content-evenly">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 d-flex flex-column align-items-end property_address">
                            ...
                            <div class="position-relative d-flex justify-content-end align-items-center w-100">
                                <input type="text" name="location" value="{{ $post_data != '' ? $post_data->city->value  : old('location') }}" id="location" placeholder="المدينة" class="form-control theme-border">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 d-flex flex-column align-items-end">
                            ...
                            <input type="number" step="any" id="area" value="{{ $post_data != '' ? $post_data->area->content  : old('area') }}" name="area" placeholder="المساحة بالمتر المربع" class="form-control theme-border">
                            @if($errors->has('area'))
