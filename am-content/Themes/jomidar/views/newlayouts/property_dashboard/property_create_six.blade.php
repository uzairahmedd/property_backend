    ...
    <div class="container">
        <form method="post" action="{{ route('agent.property.six_update_property',$id) }}" class="post_form">
            ...
            <div class="description-card card align-items-end">
                ...
                <div class="document row theme-gx-32 justify-content-end">
                    <div class="col-xl-5 col-lg-4 id-number col-md-6 col-sm-12 d-flex flex-column align-items-end">
                        ...
                        <input type="text" name="id_number" value="{{ !empty( $post_data->id_number) ? $post_data->id_number->content  : old("id_number") }}" placeholder="الرجاء ادخال الكود ( تم ارساله لك عبر الرسالة نصية  )" class="form-control payment theme-border">
                    </div>
                    <div class="col-xl-5 col-lg-4 id-number col-md-6 col-sm-12 d-flex flex-column align-items-end">
            ...
            <div class="d-flex justify-content-between description-btn-group">
                ...
                <a href="{{ route('agent.property.five_edit_property', $id)}}" class="btn btn-theme-secondary previous_btn center_property">السابق</a>
            </div>
        </form>
    </div>
