            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent2">
                        ...
                        <form method="post" action="{{ route('admin.property.block_update') }}"
                              class="land_block_updateform">
                            @csrf
                            <div class="form-group mt-3">
                                <label for="status">{{__('labels.property')}}</label>
                                <select class="form-control form-select-lg mb-3" required="" name="status" id="status"
                                        aria-label=".form-select-lg example">
                                    <option value='' disabled selected>{{__('labels.select_property_type')}}</option>
                                    @foreach($status_category as $status)
                                        <option
                                            value='{{$status->id}}' {{ $info != '' && $info->property_status_type->category_id == $status->id ? 'selected' : '' }}>{{Session::get('locale')=='ar' ? $status->ar_name : $status->name}}</option>
                                    @endforeach
                                </select>
                                <input id="term_id" type="hidden" name="term_id"
                                       value="{{ $info->id }}">
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="exampleFormControlTextarea2"
                                               value="{{$info->title}}" placeholder="{{__('labels.english_title')}}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_title" id="exampleFormControlTextarea1"
                                               value="{{$info->ar_title}}" placeholder="{{__('labels.arabic_title')}}"
                                               required="" class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="city" required="" id="land_block_city"
                                                    class="form-control form-select-lg mb-3 select2"
                                                    aria-label=".form-select-lg example">
                                                <option value='' disabled
                                                        selected>{{__('labels.select_your_city')}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="land_block_district" name="district">
                                                ...
                                                @foreach($district as $dist)
                                                    <option name="$dist->name"
                                                            value="{{ $dist->id }}" {{ $info != '' && $info->post_district->district_id == $dist->id ? 'selected' : (old('district') == $dist->id ? 'selected' : '')}}>{{ Session::get('locale') == 'ar' ?  $dist->ar_name : $dist->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location"
                                                   value="{{!empty($info->post_district) ? $info->post_district->value : ''}}"
                                                   placeholder="{{__('labels.address')}}" required=""
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div
                                            ...
                                            <img id="first_image" src="{{asset('assets/images/bx_image-alt.png')}}"
                                                 alt="">
...
{{--                                        @foreach($parent_category as $row)--}}
                            ...
                            <div class="wrapper">
                                ...
                                {{--                                            <input type="text" name="plot_number[]" id="number" value="{{!empty($landblock) ? $landblock->plot_number : ''}}" required=""--}}
                                {{--                                                   placeholder="{{__('labels.plot_number')}}" class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-2">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label for="price">{{__('labels.plot_price')}}</label>--}}
                                {{--                                            <input type="text" name="plot_price[]" id="price" required="" value="{{!empty($landblock) ? $landblock->price : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.plot_price')}}" class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-2">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label for="planned_number">{{__('labels.planned_number')}}</label>--}}
                                {{--                                            <input type="text" name="planned_number[]" id="planned_number" required="" value="{{!empty($landblock) ? $landblock->planned_number : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.planned_number')}}" class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-2">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label for="total_area">{{__('labels.plot_area')}}</label>--}}
                                {{--                                            <input type="text" name="total_area[]" id="total_area" required="" value="{{!empty($landblock) ? $landblock->total_area : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.plot_area')}}" class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                                {{--                                <hr>--}}
                                ...
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label--}}
                                {{--                                                for="bottom_left_coordinate">{{__('labels.plot_center_coordinate')}}</label>--}}
                                {{--                                            <input type="text" name="center_coordinate[]" id="center_coordinate" value="{{!empty($landblock) ? $landblock->center_coordinate : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.comma_seperated')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-4">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label--}}
                                {{--                                                for="bottom_left_coordinate">{{__('labels.plot_bottom_left_coordinate')}}</label>--}}
                                {{--                                            <input type="text" name="bottom_left_coordinate[]"--}}
                                {{--                                                   id="bottom_left_coordinate" required="" value="{{!empty($landblock) ? $landblock->bottom_left_coordinate : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.plot_bottom_left_coordinate')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-3">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label--}}
                                {{--                                                for="bottom_right_coordinate">{{__('labels.plot_right_bottom_coordinate')}}</label>--}}
                                {{--                                            <input type="text" name="bottom_right_coordinate[]"--}}
                                {{--                                                   id="bottom_right_coordinate" required="" value="{{!empty($landblock) ? $landblock->bottom_right_coordinate : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.plot_right_bottom_coordinate')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-4">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label--}}
                                {{--                                                for="top_right_coordinate">{{__('labels.plot_top_right_coordinate')}}</label>--}}
                                {{--                                            <input type="text" name="top_right_coordinate[]" id="top_right_coordinate" value="{{!empty($landblock) ? $landblock->top_right_coordinate : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.plot_top_right_coordinate')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-4">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label--}}
                                {{--                                                for="top_left_coordinate">{{__('labels.plot_top_left_coordinate')}}</label>--}}
                                {{--                                            <input type="text" name="top_left_coordinate[]" id="top_left_coordinate" value="{{!empty($landblock) ? $landblock->top_left_coordinate : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.plot_top_left_coordinate')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                                ...
                                {{--                                            <input type="text" name="left_measurement[]" id="Left_measurement" value="{{!empty($landblock) ? $landblock->left_measurement : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.left_measurement')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-3">--}}
                                ...
                                {{--                                            <input type="text" name="right_measurement[]" id="right_measurement" value="{{!empty($landblock) ? $landblock->right_measurement : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.right_measurement')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                ...
                                {{--                                            <input type="text" name="top_measurement[]" id="top_measurement" required="" value="{{!empty($landblock) ? $landblock->top_measurement : ''}}"--}}
                                {{--                                                   placeholder="{{__('labels.top_measurement')}}" class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                    <div class="col-sm-3">--}}
                                {{--                                        <div class="form-group">--}}
                                {{--                                            <label for="bottom_measurement">{{__('labels.bottom_measurement')}}</label>--}}
                                {{--                                            <input type="text" name="bottom_measurement[]" id="bottom_measurement" value="{{!empty($landblock) ? $landblock->bottom_measurement : ''}}"--}}
                                {{--                                                   required="" placeholder="{{__('labels.bottom_measurement')}}"--}}
                                {{--                                                   class="form-control">--}}
                                {{--                                        </div>--}}
                                {{--                                    </div>--}}
                                {{--                                </div>--}}
                            ...
                            {{--                            <p>--}}
                            {{--                                <button class="add_fields btn btn-success">{{__('labels.add_more_plots')}}</button>--}}
                            {{--                            </p>--}}
                            <!-- <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                        ...
                        <form method="post" action="{{ route('admin.property.store') }}">
                            ...
                            <div class="form-group d-flex justify-content-between"
                                ...
                                <button class="btn btn-primary save-btn" type="submit">{{__('labels.update')}}
                                </button>
                            </div>
                            <!-- </form>
                        </div> -->
