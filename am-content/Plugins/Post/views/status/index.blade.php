...
@section('content')
@include('layouts.backend.partials.headersection',['title'=>'Status List'])
<div class="card"  >
	<div class="card-body">
		<div class="row mb-30">
			<div class="col-lg-6">
			...
			<div class="col-lg-6">
				<div class="add-new-btn">
					<a href="{{ route('admin.status.create') }}" class="btn float-right btn-primary">{{ __('Add New') }}</a>
				</div>
			</div>
		</div>
		<div class="card-action-filter mt-3">
			<form method="post" id="basicform" action="{{ route('admin.statuses.destroy') }}">
				@csrf
