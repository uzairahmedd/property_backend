...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = array(
            ...
            array("id"=>"7","name"=>"Bedroom","ar_name"=>"غرف النوم","slug"=>"number","type"=>"option","p_id"=>null,"featured"=>"1","user_id"=>"1","status"=>"0","land_area"=>null,"buildup_area"=>null,"property_age"=>null,"faatures_section"=>null,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
            array("id"=>"8","name"=>"Bathroom","ar_name"=>"دورات المياه","slug"=>"number","type"=>"option","p_id"=>null,"featured"=>"1","user_id"=>"1","status"=>"0","land_area"=>null,"buildup_area"=>null,"property_age"=>null,"faatures_section"=>null,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),'updated_at' => Carbon::now()->format('Y-m-d H:i:s')),
