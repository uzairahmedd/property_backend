                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="furnishing" id="furnishing" class="form-control">
                                                <option value="1" {{ !empty($info->property_condition) && $info->property_condition->content == 1 ? "selected"  : "" }}>Furnished</option>
                                                <option value="2" {{ !empty($info->property_condition) && $info->property_condition->content == 2 ? "selected"  : "" }}>Semi Furnished</option>
                                                <option value="3" {{ !empty($info->property_condition) && $info->property_condition->content == 3 ? "selected"  : "" }}>Un-Furnished</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
