                    ...
                    <form method="post" action="{{ route('admin.property.block_store') }}" class="land_block_basicform">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="bottom_left_coordinate">{{__('labels.comma_seperated')}}</label>
