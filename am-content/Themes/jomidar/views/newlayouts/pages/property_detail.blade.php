        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="d-flex justify-content-end align-items-center">
                <ul class="breadcrumb mb-0">
                    <li class="breadcrumb-item active theme-text-seondary-black"
                        aria-current="page">{{ $property->title }}</li>
                    <li class="breadcrumb-item"><a href="#"
                                                   class="theme-text-blue text-decoration-none">{{$property->property_status_type->category->name}}</a>
                    </li>
            ...
            <div
                class="d-flex flex-wrap-reverse justify-content-end justify-content-lg-between align-items-center my-3">
                <div class="col-12 col-lg-8 col-xl-7 col-xxl-6">
                    <ul class="detail list-unstyled mb-0 d-flex flex-column flex-sm-row align-items-end justify-content-between align-items-sm-center">
                        ...
                        <li class="d-flex mb-3 mb-sm-0">
                            ...
                            @if (Auth::check())
                                <input type="hidden" value="{{ route('property.favourite') }}"
                                       id="favourite_property_url">
                                @php
                ...
                <div class="col-12 col-lg-6 col-xxl-5">
                    <div class="card text-end theme-bg-white align-items-end">
                        ...
                        <ul class="list-unstyled d-flex flex-column flex-sm-row align-items-end mb-5 flex-wrap justify-content-end">
                                ...
                                @foreach ($property->option_data as $value)
                                    <li class="d-flex align-items-center mb-3 mb-sm-3">
                                        ...
                                        @if($value->category->name =='Bathrooms')
                                            ...
                                            <img src="{{theme_asset('assets/images/shower.png')}}"
                                                 title="{{ $value->category->name }}" data-toggle="tooltip" alt="">
                                        @elseif($value->category->name =='Bedrooms')
                                            <img src="{{theme_asset('assets/images/room.png')}}"
                                                 title="{{ $value->category->name }}" data-toggle="tooltip" alt="">

                                        @elseif($value->category->name =='Parking')
                                            <img src="{{theme_asset('assets/images/parking.png')}}"
                                                 title="{{ $value->category->name }}" data-toggle="tooltip" alt="">

                                        @elseif($value->category->name =='lounges')
                                            <img src="{{theme_asset('assets/images/lunch.png')}}"
                                                 title="{{ $value->category->name }}" data-toggle="tooltip" alt="">

                                        @elseif($value->category->name =='Boards')
                                            <img src="{{theme_asset('assets/images/board-room.png')}}"
                                                 title="{{ $value->category->name }}" data-toggle="tooltip" alt="">
                                        @endif
                                    </li>
                            ...
                            <li class="d-flex align-items-center mb-3 mb-sm-3">
                                ...
                                <img src="{{theme_asset('assets/images/area.png')}}"
                                     title="{{ $property->area->type }} in sqm" data-toggle="tooltip">
                            </li>
                        </ul>
                        @php
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-between w-100">
                            <button
                                class="contact-btn col-12 col-sm-7 theme-bg-sky border-0 theme-text-white font-medium mb-sm-0">
                                <img src="{{theme_asset('assets/images/phone.png')}}" alt="" class="phone me-2">
                                {{ isset($info->phone) ? $info->phone : 'N/A'  }}
                            </button>
                            <button
                                class="contact-btn col-12 col-sm-4 theme-bg-white border-0 theme-text-blue font-medium"
                    ...
                    <div class="d-flex flex-column align-items-end py-4">
                        ...
                        @foreach ($property->option_data as $options_data)
                            <div class="row w-100 mb-3">
                                ...
                                <div class="col-6 text-end">
                                    <span
                                        class="font-16 theme-text-seondary-black">{{ $options_data->category->name }}</span>
                                </div>
                            </div>
                        @endforeach
                    ...
                    @isset($property->post_city->value)
                        <div class="theme-bg-secondary text-center mb-0 pb-0 position-relative">
                            ...
                            <iframe id="gmap_canvas" width="100%" height="400"
                                    src="https://maps.google.com/maps?q={{ $property->post_city->value }}%20&t=&z=15&ie=UTF8&iwloc=&output=embed"
