                    ...
                    <tr>
                        <td>{{ $plugin['Plugin Name'] }}
                            <div class="hover">
                                ...
                                <a class="last" href="{{ route('admin.plugin.active',$plugin['Text Domain']) }}">{{ __('Active') }}</a>
                                @else
                                <a class="last" href="{{ route('admin.plugin.deactive',$plugin['Text Domain']) }}">{{ __('Deactive') }}</a>
                                @endif
                            </div>
                        </td>
                        <td>
                            ...
                            <div class="plugin-anthor-info d-flex">
                                <span><strong>{{ __('Version') }}:</strong>{{ $plugin['Version'] }}</span>
                                <span class="last"><strong>{{ __('By') }}</strong><a target="_blank" href="{{ $plugin['Author URI'] }}">{{ $plugin['Author'] }}</a></span>
                            </div>
                        </td>
                    </tr>
                    @endforeach
