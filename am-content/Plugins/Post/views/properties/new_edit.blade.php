            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs d-flex" id="myTab" role="tablist">
                    ...
                    <li class="nav-item step_1">
                        <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#step_1" role="tab" aria-controls="step_1" aria-selected="true">{{__('labels.step_1')}}</a>
                    </li>
                    {{--Step 2 Tab--}}
                    <li class="nav-item step_2" id="step_2_li">
                        <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_2" role="tab" aria-controls="step_2" aria-selected="true">{{__('labels.step_2')}}</a>
                    </li>
                    {{--Step 3 Tab--}}
                    <li class="nav-item step_3">
                        <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_3" role="tab" aria-controls="step_3" aria-selected="true">{{__('labels.step_3')}}</a>
                    </li>
                    {{--Step 4 Tab--}}
                    <li class="nav-item step_4">
                        <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#images" role="tab" aria-controls="profile" aria-selected="false">{{__('labels.step_4')}}</a>
                    </li>
                    {{--Step 5 Tab--}}
                    <li class="nav-item step_5">
                        <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_5" role="tab" aria-controls="step_5" aria-selected="true">{{__('labels.step_5')}}</a>
                    </li>
                    {{--Step 6 Tab--}}
                    <li class="nav-item step_6">
                        <a class="nav-link" id="home-tab3" data-toggle="tab" href="#step_6" role="tab" aria-controls="step_6" aria-selected="true">{{__('labels.step_6')}}</a>
                    </li>
                    {{--Step 7 Tab--}}
                    <li class="nav-item step_7">
                        <a class="nav-link" id="home-tab3" data-toggle="tab" href="#finish" role="tab" aria-controls="finish" aria-selected="true">{{__('labels.finish')}}</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent2">
                    ...
                    <div class="tab-pane fade active show" id="step_1" role="tabpanel" aria-labelledby="step_1">
                        ...
                        <div class="pt-4">
                            <form id="step_one_form" novalidate method="post" action="{{ route('admin.property.update',$info->id)}}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control selectric" id="state" name="city">
                                            ...
                                            <option value="{{ $city->id }}" {{ !empty($info->post_new_city) && $info->post_new_city->city_id == $city->id ? 'selected' : (old('city') == $city->id ? 'selected' : '')}}>{{ Session::get('locale') == 'ar' ?  $city->ar_name : $city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-6">
                                        ...
                                        <select class="form-control selectric" id="state" name="district">
                                            <option   value="">{{ __('labels.please_select_district') }}</option>
                    ...
                    <div class="tab-pane fade" id="step_2" role="tabpanel" aria-labelledby="step_2">
                        <form id="step_two_submit" novalidate method="post" action="{{ route('admin.property.second_update_property',$info->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="pt-4">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input id="all_feature_id" type="hidden" name="term_id" value="{{ $info->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 property_types">
                                        <div class="form-group">
                                            <label>{{__('labels.property_type')}}</label>
                                            <select class="form-control form-select-lg mb-3" id="property_type_select" onchange="land_triger(this, event)" aria-label=".form-select-lg example" name="category">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 land-size" id="top_land_size">
                                        <div class="form-group" id="land_size">
                                            ...
                                            <input type="text" id="land_size_area" value="{{ !empty($info->landarea) ? $info->landarea->content  : old("landarea")}}" name="landarea" placeholder="{{__('labels.area_square_meter')}}" class="form-control theme-border">
                                        </div>
                                    </div>
                                    <div class="col-sm-6" id="built_up_area">
                                        <div class="form-group">
                                            <label for="title">{{__('labels.built_up_area')}}</label>
                                            <input type="text" id="built_area" value="{{ !empty($info->builtarea) ? $info->builtarea->content  : old("builtarea")}}" name="builtarea" placeholder="{{__('labels.area_square_meter')}}" class="form-control theme-border">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row built-up-year">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center theme-gx-3 mb-4_5 ready-not-ready">
                                                <div class="radio-container col-sm-6 radio-edit-two">
                                                    <input type="radio" name="ready" value="1" data-isready='{{ !empty($info->ready)  ? $info->ready->content : old("ready")  }}' id="ready">
                                                    <span class="build-ready font-16 font-medium">{{__('labels.ready')}}</span>
                                                </div>
                                                <div class="radio-container col-sm-6 not-ready-margin">
                                                    <input type="radio" name="ready" value="0" id="not_ready" {{ !empty($info->ready)  && $info->ready->content == 0 ? "checked"  : (old("ready") == 0 ? "checked" : "")}}>
                                    ...
                                    <div class="col-sm-6 form-group mt-3" id="year_calender">
                                        <label></label>
                                        <input type="text" autocomplete="off" class="yearpicker form-control hidden" id='yearpicker' name="property_age" placeholder="Select a year" value="{{ !empty($info->property_age) ? $info->property_age->content : old('property_age') }}" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 mt-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" name="electricity_facility">
                                                <option selected>{{__('labels.electricity_meter_is_there')}}</option>
                                                <option value="0" data-val="{{!empty($info->electricity_facility) ? $info->electricity_facility->content :  old('electricity_facility')}}" {{ !empty($info->electricity_facility) && $info->electricity_facility->content == 0 ? "selected"  : "" }}>
                                                    {{__('labels.yes')}}
                                                </option>
                                                <option value="1" data-val="{{!empty($info->electricity_facility) ? $info->electricity_facility->content :  old('electricity_facility')}}" {{ !empty($info->electricity_facility) && $info->electricity_facility->content == 1 ? "selected"  : "" }}>
                                                    {{__('labels.no')}}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6 mt-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" name="water_facility">
                                                <option selected>{{__('labels.water_meter_is_there')}}</option>
                                                <option value="0" data-val="{{!empty($info->water_facility) ? $info->water_facility->content :  old('water_facility')}}" {{ !empty($info->water_facility) && $info->water_facility->content == 0 ? "selected"  : "" }}>
                                                    {{__('labels.yes')}}
                                                </option>
                                                <option value="1" data-val="{{!empty($info->water_facility) ? $info->water_facility->content :  old('water_facility')}}" {{ !empty($info->water_facility) && $info->water_facility->content == 1 ? "selected"  : "" }}>
                                                    {{__('labels.no')}}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" onchange="dropdown_btn(this, event)" name="streets">
                                                @for($i=1; $i<=4; $i++) <option class="street_sdropdown" id="street" data-streets='{{ !empty($info->streets) ? $info->streets->content : old("streets") }}' value="{{$i}}" {{ !empty($info->streets) && $info->streets->content == $i ? "selected"  : "" }}>
                                                    {{$i}}
                                                    </option>
                                                    @endfor
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ !empty($info->price) ? $info->price->price  : ""}}" name="price" placeholder="{{__('labels.property_value')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="step_3" role="tabpanel" aria-labelledby="step_3">
                        <form id="step_three_submit" novalidate method="post" action="{{ route('admin.property.third_update_property',$info->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="pt-4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input id="feature_id" type="hidden" name="term_id" value="{{ $info->id }}">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="step_5" role="tabpanel" aria-labelledby="step_5">
                        <form id="step_fifth_submit" novalidate method="post" action="{{ route('admin.property.fifth_update_property',$info->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="pt-4">
                                <div class="theme-gx-2 theme-gy-36 d-flex justify-content-between align-items-center flex-wrap p-2 form-check" id="tick_div">
                    ...
                    <div class="tab-pane fade" id="step_6" role="tabpanel" aria-labelledby="step_6">
                        <form id="step_sixth_submit" novalidate method="post" action="{{ route('admin.property.sixth_update_property',$info->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="pt-4">
                                <div class="row">
                                ...
                                <div class="chek-info d-flex flex-column justify-content-start align-items-start">
                                    <div class="document theme-gx-32 d-flex justify-content-end align-items-end">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-start terms-check">
                                            <label class="form-check-label check-box-terms" for="inlineCheckbox1"> {{__("labels.is_there_mortage")}}</label>
                                            <span class="theme-text-seondary-black font-16 ms-1"> </span>
                                            <input class="form-check-input" name="rule[]" type="checkbox" id="inlineCheckbox1" value="1" {{ !empty( $info->rules) && str_contains($info->rules->content, '1') ? "checked"  : old("rule") }}>

                                        </div>
                                    </div>
                                    <div class="document theme-gx-32 d-flex justify-content-start align-items-start">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-start terms-check">
                                            <label class="form-check-label check-box-terms" for="inlineCheckbox2"> {{__("labels.right_and_obligations")}}</label>
                                            <span class="theme-text-seondary-black font-16 ms-1"> </span>
                                            <input class="form-check-input" name="rule[]" type="checkbox" id="inlineCheckbox2" value="2" {{ !empty( $info->rules) && str_contains($info->rules->content, '2') ? "checked"  : old("rule") }}>
                                        </div>
                                    </div>
                                    <div class="document theme-gx-32 d-flex justify-content-end align-items-end">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-start terms-check">
                                            <label class="form-check-label check-box-terms" for="inlineCheckbox3">{{__("labels.info_property_effects")}}</label>
                                            <span class="theme-text-seondary-black font-16 ms-1"> </span>
                                            <input class="form-check-input" name="rule[]" type="checkbox" id="inlineCheckbox3" value="3" {{ !empty( $info->rules) && str_contains($info->rules->content, '3') ? "checked"  : old("rule") }}>
                                        </div>
                                    </div>
                                    <div class="document theme-gx-32 d-flex justify-content-end align-items-end">
                                        <div class="col-12 mb-3 d-flex align-items-center justify-content-start terms-check">
                                            <label class="form-check-label check-box-terms" for="inlineCheckbox4">{{__("labels.Property_disputes")}}</label>
                                            <span class="theme-text-seondary-black font-16 ms-1"> </span>
                                            <input class="form-check-input" name="rule[]" type="checkbox" id="inlineCheckbox4" value="4" {{ !empty( $info->rules) && str_contains($info->rules->content, '4') ? "checked"  : old("rule") }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
